public class Qiaoke.TerminalMenu : Gtk.Menu {
  ...
  public TerminalMenu (TerminalManager manager) {
    ...
    Hotkey.bind(Config.circle_monitor,  accel_circle_monitor);
  }
  ...
  private bool accel_circle_monitor(Gtk.AccelGroup accel_group, GLib.Object acceleratable, uint keyval, Gdk.ModifierType modifier) {
    Qiaoke.MainWindow.get_instance().circle_monitor();
    return true;
  }
